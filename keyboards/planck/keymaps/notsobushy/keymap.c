 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  "   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Brite| Ctrl | Alt  |Adjust|  GUI | Space| Lower| Raise| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    BACKLIT, KC_LCTL, KC_LALT, ADJUST,  KC_LGUI, KC_SPC,  LOWER,   RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_ADJUST] = LAYOUT_planck_grid(
    _______, RESET,   DEBUG,   TERM_ON, TERM_OFF, _______, _______, DF(QWERTY), DF(LOWER), DF(RAISE), DF(ADJUST), _______,
    _______, _______, _______, _______, _______,  LCG_SWP, LCG_NRM, _______,    _______,   _______,   _______,    _______,
